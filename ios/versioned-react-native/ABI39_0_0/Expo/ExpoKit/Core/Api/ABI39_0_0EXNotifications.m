...
@implementation ABI39_0_0RCTConvert (NSCalendarUnit)

ABI39_0_0RCT_ENUM_CONVERTER(NSCalendarUnit,
                   (@{
...
@interface ABI39_0_0EXNotifications ()

// unversioned ABI39_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI39_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI39_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI39_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI39_0_0EXNotifications

ABI39_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI39_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI39_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI39_0_0UMModuleRegistryHolderReactModule class]] moduleRegistry] getModuleImplementingProtocol:@protocol(ABI39_0_0UMConstantsInterface)];
...
ABI39_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
                 getExponentPushTokenAsyncWithResolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
...
ABI39_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI39_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI39_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI39_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
...
ABI39_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
...
ABI39_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.applicationIconBadgeNumber = [ABI39_0_0RCTConvert NSInteger:payload[@"count"]] ?: 0;
  ...
  localNotification.fireDate = [ABI39_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI39_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI39_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI39_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI39_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI39_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI39_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI39_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI39_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI39_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI39_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI39_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI39_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI39_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI39_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI39_0_0RCTPromiseRejectBlock)reject)
{
  [ABI39_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI39_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI39_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI39_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI39_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
