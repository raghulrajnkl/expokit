...
@interface ABI39_0_0EXUtil ()

@property (nonatomic, weak) id<ABI39_0_0EXUtilService> kernelUtilService;

@end

ABI39_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI39_0_0EXUtil, util)

@implementation ABI39_0_0EXUtil

ABI39_0_0EX_EXPORT_SCOPED_MODULE(ExponentUtil, UtilService);

- (instancetype)initWithExperienceStableLegacyId:(NSString *)experienceStableLegacyId scopeKey:(NSString *)scopeKey kernelServiceDelegate:(id<ABI39_0_0EXUtilService>)kernelServiceInstance params:(NSDictionary *)params
{
