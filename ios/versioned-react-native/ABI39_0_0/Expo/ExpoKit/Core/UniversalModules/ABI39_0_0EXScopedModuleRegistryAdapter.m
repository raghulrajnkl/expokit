                           ...
                           withKernelServices:(NSDictionary *)kernelServices
{
  ...
  ABI39_0_0EXUpdatesBinding *updatesBinding = [[ABI39_0_0EXUpdatesBinding alloc] initWithScopeKey:scopeKey
  ...
  ABI39_0_0EXConstantsBinding *constantsBinding = [[ABI39_0_0EXConstantsBinding alloc] initWithParams:params deviceInstallationUUIDManager:kernelServices[@"EXDeviceInstallationUUIDService"]];
  ...
  if ([params[@"constants"][@"appOwnership"] isEqualToString:@"expo"]) {
    ABI39_0_0EXScopedFacebook *scopedFacebook = [[ABI39_0_0EXScopedFacebook alloc] initWithScopeKey:scopeKey andParams:params];
  ...
  ABI39_0_0EXSensorsManagerBinding *sensorsManagerBinding = [[ABI39_0_0EXSensorsManagerBinding alloc] initWithScopeKey:scopeKey andKernelService:kernelServices[@"EXSensorManager"]];
  ...
  ABI39_0_0EXScopedSecureStore *secureStoreModule = [[ABI39_0_0EXScopedSecureStore alloc] initWithScopeKey:scopeKey];
  [moduleRegistry registerExportedModule:secureStoreModule];
#endif

#if __has_include(<ABI39_0_0EXAmplitude/ABI39_0_0EXAmplitude.h>)
  ABI39_0_0EXScopedAmplitude *amplitudeModule = [[ABI39_0_0EXScopedAmplitude alloc] initWithExperienceStableLegacyId:experienceStableLegacyId];
  [moduleRegistry registerExportedModule:amplitudeModule];
#endif

#if __has_include(<ABI39_0_0EXPermissions/ABI39_0_0EXPermissions.h>)
  ABI39_0_0EXScopedPermissions *permissionsModule = [[ABI39_0_0EXScopedPermissions alloc] initWithScopeKey:scopeKey andConstantsBinding:constantsBinding];
  ...
  ABI39_0_0EXScopedBranch *branchModule = [[ABI39_0_0EXScopedBranch alloc] initWithScopeKey:scopeKey];
  ...
  ABI39_0_0EXTaskManager *taskManagerModule = [[ABI39_0_0EXTaskManager alloc] initWithScopeKey:scopeKey];
  ...
  ABI39_0_0EXScopedErrorRecoveryModule *errorRecovery = [[ABI39_0_0EXScopedErrorRecoveryModule alloc] initWithScopeKey:scopeKey];
  [moduleRegistry registerExportedModule:errorRecovery];
#endif

#if __has_include(<ABI39_0_0EXFirebaseCore/ABI39_0_0EXFirebaseCore.h>)
  ABI39_0_0EXScopedFirebaseCore *firebaseCoreModule = [[ABI39_0_0EXScopedFirebaseCore alloc] initWithScopeKey:scopeKey andConstantsBinding:constantsBinding];
  ...
  ABI39_0_0EXScopedNotificationsEmitter *notificationsEmmitter = [[ABI39_0_0EXScopedNotificationsEmitter alloc] initWithScopeKey:scopeKey];
  ...
  ABI39_0_0EXScopedNotificationsHandlerModule *notificationsHandler = [[ABI39_0_0EXScopedNotificationsHandlerModule alloc] initWithScopeKey:scopeKey];
  [moduleRegistry registerExportedModule:notificationsHandler];
#endif

#if __has_include(<ABI39_0_0EXNotifications/ABI39_0_0EXNotificationsHandlerModule.h>)
  ABI39_0_0EXScopedNotificationBuilder *notificationsBuilder = [[ABI39_0_0EXScopedNotificationBuilder alloc] initWithScopeKey:scopeKey];
  ...
  ABI39_0_0EXScopedNotificationSchedulerModule *schedulerModule = [[ABI39_0_0EXScopedNotificationSchedulerModule alloc] initWithScopeKey:scopeKey];
  ...
  ABI39_0_0EXScopedNotificationPresentationModule *notificationPresentationModule = [[ABI39_0_0EXScopedNotificationPresentationModule alloc] initWithScopeKey:scopeKey];
  ...
  ABI39_0_0EXScopedNotificationCategoriesModule *categoriesModule = [[ABI39_0_0EXScopedNotificationCategoriesModule alloc] initWithScopeKey:scopeKey];
